...
UAV-TAlign uses a strong off-the-shelf multimodal matcher as its pairwise evidence generator. In
the current PRCV pipeline, the default backend is the MINIMA family with the RoMa branch, while the
...
The canonical decision uses a baseline-aware verification rule. A scene is retained
