...
\caption{Overview of UAV-TAlign. The pipeline builds on pairwise matching, but makes the final
decision at the scene level through candidate scheduling, robust homography aggregation, and
QA-aware acceptance.}
...
it passes a minimum-quality gate on these statistics. The overall geometric treatment remains rooted
