...
the MINIMA RoMa branch in its direct pairwise form, without the reliability-guided evidence
selection, robust scene consensus, or QA-aware verification introduced by UAV-TAlign
...
outcome category. This unified post-processing is important because it makes the pairwise baseline
...
The frozen main-table baseline choices are as follows. Raw MINIMA uses the MINIMA RoMa backend
...
The formal LoFTR result is obtained under a resize-aware inference setting. In the full-run
