...
Unified inference wrappers are used only to standardize model loading, image I/O, homography
fitting, and output schemas while preserving the public pretrained baseline settings.
