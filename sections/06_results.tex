...
\caption{Scene-level proxy evidence. Passing scenes cluster near low severe-outlier ratios, while
failing scenes are associated with stronger baseline-relative QA outlier signals. Marker size
