...
For the PRCV version of this work, we package UAV-TAlign-1K as a focused public evaluation
...
essential: the pairwise and scene-level tables provide two complementary views of practical
...
current proxy family includes edge-overlap improvement, gradient-NCC improvement, the ratio of
